...
\begin{table}[]
  ...
  \begin{tabular}{SS|SS|SSS}
     \toprule
\multicolumn{2}{c|}{Wert 1} & \multicolumn{2}{c|}{Wert
3}&\multicolumn{3}{c}{Wert 8}\\
    \midrule
...
\name{Ohm}schen Widerstandes und der Induktivität von Wert 18 mithilfe
...
Im selben Plot ist ebenfalls die von der Theorie durch
