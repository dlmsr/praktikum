...
Die Brennweitenbestimmung nach \name{Bessel} liefert ebenfalls nur geringe statistische Fehler. Die Brennweiten der verschiedenen Farben lassen sich im Rahmen dieser Messung nicht unterscheiden. Dies bedeutet, dass die verwendete Linse so gut wie keine chromatische Aberration zeigt.
...
Der Grund für den großen Fehler ist aber vermutlich nicht bei der Bestimmungsmethode von \name{Abbe} zu finden, sondern eher darin, dass das Linsensystem als dicke Linse genähert betrachtet wird.
