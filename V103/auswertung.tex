...
\end{equation}
%
Abbildung~\ref{fig:stahl} zeigt einen Darstellung der Meßwerte und der
Regressionsgerade. Die roten Punkte wurden für die Regression
herangezogen. Es ergibt sich nach Regression und Fehlerrechnung
folgender Wert für $E$:
%
\begin{equation}
...
$m=\SI{5416}{\gram}$ verwendet. Für diesen ergibt sich:
%
\begin{equation}
  d = \SI{9.985(3)}{\kilo\newton\per\milli\metre}
\end{equation}
...
und der Fehlerrechnung läßt sich ein Wert für den E-Modul angeben:
%
\begin{equation}
...
die Tabelle~\ref{tab:messing-durchmesser} und den Wert:
%
\begin{equation}
...
dargestellt. Tabelle~\ref{tab:messing} enthält die Meßwerte dazu. Als
Ergebnis erhält man zwei Werte für $E$:
\begin{align}
 E&=\SI{143.8(88)}{\kilo\newton\per\milli\metre\squared} &
 E&=\SI{159.4(54)}{\kilo\newton\per\milli\metre\squared}
\end{align}
