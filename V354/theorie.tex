...
Eine elektrische Schaltung, die einen \name{ohm}schen Widerstand R, eine Induktivität L und eine Kapazität C enthält, welche eine Masche bilden, wird als RLC-Kreis bezeichnet. 
In Abb. \ref{fig:rlc-kreis} ist der schematische Aufbau eines RLC-Kreises zu sehen.
%
\begin{figure}[h!!]
\centering
\includegraphics[width=0.4\textwidth]{rlc_kreis}
...
Um diese Schwingungen mathematisch zu beschreiben, werden die \name{Kirchhoff}schen Regeln verwendet, welche sich aus den \name{Maxwell}gleichungen ergeben.
Da es sich bei den Bauelemente des RLC-Kreises um konzentrierte Bauelemente handelt, sind diese Regeln hier anwendbar.
Die erste \name{Kirchhoff}sche Regel, die Knotenregel, besagt, dass die Summe aller gerichteten Ströme in einem Knoten gleich Null ist.
Die zweite \name{Kirchhoff}sche Regel, welche Maschenregel genannt wird, legt dar, dass die Summe aller Spannungen einer Masche verschwindet.
